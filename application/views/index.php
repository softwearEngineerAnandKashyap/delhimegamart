					...
					<div id="owl-slider-left" class="owl-carousel">
						<div class="slider-left-carousel">
							<div class="slider-left-product">
								<a href="#"><img src="<?php echo base_url(); ?>assets/img/product/slider-product.jpg" alt="product"></a>
						...
						<div class="slider-left-carousel">
							<div class="slider-left-product">
								<a href="#"><img src="<?php echo base_url(); ?>assets/img/product/slider-product-2.jpg" alt="product"></a>
								<div class="slider-product-button">
									<p class="add-chart"><a href="#">Add To Cart</a></p>
								</div>
							</div>
				...
				<div class="main-slider">
					<div class="slider">
						<div id="mainSlider" class="nivoSlider slider-image">
							<img src="<?php echo base_url(); ?>assets/img/slider/s1.jpg" alt="main slider" title="#htmlcaption1"/>
			...
			<div class="col-md-3 col-sm-4">
				<div class="product-catagori-area">
					...
					<div class="best-seller-area">
						...
						<div class="best-sell-product">
							<div class="best-product-img">
								<a href="#"><img src="<?php echo base_url(); ?>assets/img/product/best-product-1.png" alt="product"></a>
							</div>
						...
						<div class="best-sell-product">
							<div class="best-product-img">
								<a href="#"><img src="<?php echo base_url(); ?>assets/img/product/best-product-2.png" alt="product"></a>
							</div>
							<div class="best-product-content">
								<h2><a href="#">Et harum quidem red T-shirt</a></h2>
								<h3>$45.00</h3>
						...
						<div class="best-sell-product">
							<div class="best-product-img">
								<a href="#"><img src="<?php echo base_url(); ?>assets/img/product/best-product-3.png" alt="product"></a>
							</div>
							<div class="best-product-content">
								<h2><a href="#">Et harum quidem red T-shirt</a></h2>
								<h3>$45.00</h3>
					...
					<div class="add-kids single-add">
						<a href="#"><img src="<?php echo base_url(); ?>assets/img/banner/kids-ad.jpg" alt="add"></a>
					</div>
					<div class="testmonial-area fix">
						...
						<div id="owl-testmonial" class="owl-carousel">
							<div class="testmonial fix">
								...
								<h3>-MatthE Jensen</h3>
								<img src="<?php echo base_url(); ?>assets/img/testmonial.jpg" alt="">
							</div>
							<div class="testmonial fix">
								<span><i class="fa fa-quote-left"></i></span>
								<p>Lorem ipsum dolor consetetuer adipiscing elit. Aenean commdo ligula eget dolor. Aenean massa.</p>
			...
			<div class="col-md-9 col-sm-8">
				<div class="product-items-area">
							...
							<div id="product-slider-two" class="owl-carousel">
								<div class="col-md-4">
									<div class="single-product">
										<div class="single-product-img">
											<a href="#">
												<img class="primary-img" src="<?php echo base_url(); ?>assets/img/product/men-1.jpg" alt="product">
												<img class="secondary-img" src="<?php echo base_url(); ?>assets/img/product/single-product-3.jpg" alt="product">
											</a>
											<div class="single-product-action">
												<a href="#"><i class="fa fa-external-link"></i></a>
												<a href="#"><i class="fa fa-shopping-cart"></i></a>
								...
								<div class="col-md-4">
									<div class="single-product">
										<div class="single-product-img">
											<a href="#">
												<img class="primary-img" src="<?php echo base_url(); ?>assets/img/product/men-2.jpg" alt="product">
												<img class="secondary-img" src="<?php echo base_url(); ?>assets/img/product/single-product-3.jpg" alt="product">
											</a>
											<div class="single-product-action">
												<a href="#"><i class="fa fa-external-link"></i></a>
								...
								<div class="col-md-4">
									<div class="single-product">
										<div class="single-product-img">
											<a href="#">
												<img class="primary-img" src="<?php echo base_url(); ?>assets/img/product/men-3.jpg" alt="product">
												<img class="secondary-img" src="<?php echo base_url(); ?>assets/img/product/single-product-3.jpg" alt="product">
											</a>
											<div class="single-product-action">
												<a href="#"><i class="fa fa-external-link"></i></a>
					...
					<div class="arrivals-area single-add">
						<a href="#"> <img src="<?php echo base_url(); ?>assets/img/banner/arrivals.jpg" alt="arrivals"> </a>
					</div>
					<div class="product-items">
							...
							<div id="product-slider-women" class="owl-carousel">
								<div class="col-md-4">
									<div class="single-product">
										<div class="single-product-img">
											<a href="#">
												<img class="primary-img" src="<?php echo base_url(); ?>assets/img/product/single-product-2.jpg" alt="product">
												<img class="secondary-img" src="<?php echo base_url(); ?>assets/img/product/single-product-2.jpg" alt="product">
											</a>
											<div class="single-product-action">
												<a href="#"><i class="fa fa-external-link"></i></a>
												<a href="#"><i class="fa fa-shopping-cart"></i></a>
								...
								<div class="col-md-4">
									<div class="single-product">
										<div class="single-product-img">
											<a href="#">
												<img class="primary-img" src="<?php echo base_url(); ?>assets/img/product/women-2.jpg" alt="product">
												<img class="secondary-img" src="<?php echo base_url(); ?>assets/img/product/single-product-2.jpg" alt="product">
											</a>
											<div class="single-product-action">
												<a href="#"><i class="fa fa-external-link"></i></a>
								...
								<div class="col-md-4">
									<div class="single-product">
										<div class="single-product-img">
											<a href="#">
												<img class="primary-img" src="<?php echo base_url(); ?>assets/img/product/women-3.jpg" alt="product">
												<img class="secondary-img" src="<?php echo base_url(); ?>assets/img/product/single-product-2.jpg" alt="product">
											</a>
											<div class="single-product-action">
												<a href="#"><i class="fa fa-external-link"></i></a>
							...
							<div id="product-slider-kids" class="owl-carousel">
								<div class="col-md-4">
									<div class="single-product">
										<div class="single-product-img">
											<a href="#">
												<img class="primary-img" src="<?php echo base_url(); ?>assets/img/product/kids-1.jpg" alt="product">
												<img class="secondary-img" src="<?php echo base_url(); ?>assets/img/product/single-product-1.jpg" alt="product">
											</a>
											<div class="single-product-action">
												<a href="#"><i class="fa fa-external-link"></i></a>
												<a href="#"><i class="fa fa-shopping-cart"></i></a>
								...
								<div class="col-md-4">
									<div class="single-product">
										<div class="single-product-img">
											<a href="#">
												<img class="primary-img" src="<?php echo base_url(); ?>assets/img/product/kids-2.jpg" alt="product">
												<img class="secondary-img" src="<?php echo base_url(); ?>assets/img/product/single-product-1.jpg" alt="product">
											</a>
											<div class="single-product-action">
												<a href="#"><i class="fa fa-external-link"></i></a>
								...
								<div class="col-md-4">
									<div class="single-product">
										<div class="single-product-img">
											<a href="#">
												<img class="primary-img" src="<?php echo base_url(); ?>assets/img/product/kids-3.jpg" alt="product">
												<img class="secondary-img" src="<?php echo base_url(); ?>assets/img/product/single-product-1.jpg" alt="product">
											</a>
											<div class="single-product-action">
												<a href="#"><i class="fa fa-external-link"></i></a>

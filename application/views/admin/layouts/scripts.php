   ...
   <script src="<?php echo base_url(); ?>assets/admin_assets/js/summernote.min.js"></script>
    ...
    <!-- jQuery UI -->
    <script src="<?php echo base_url(); ?>assets/admin_assets/js/plugins/jquery-ui/jquery-ui.min.js"></script>

    <!-- GITTER -->
    <script src="<?php echo base_url(); ?>assets/admin_assets/js/plugins/gritter/jquery.gritter.min.js"></script>

    <!-- Sparkline -->
   <!--  <script src="<?php echo base_url(); ?>assets/admin_assets/Adrilzjs/plugins/sparkline/jquery.sparkline.min.js"></script> -->

    <!-- Sparkline demo data  -->
    <script src="<?php echo base_url(); ?>assets/admin_assets/js/demo/sparkline-demo.js"></script>
    ...
    <!-- parsley Validation -->
    <script src="<?php echo base_url(); ?>assets/admin_assets/js/parsley.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/admin_assets/js/parsley.extend.js"></script>
   <!-- Summernote -->
    <script>
      $(document).ready(function() {
            setTimeout(function() {
                ...
                toastr.success('Welcome Admin', 'Welcome to Brandbix');

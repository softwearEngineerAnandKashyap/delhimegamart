            ...
            <div class="sidebar-collapse">
               <ul class="nav metismenu" id="side-menu">
                 ...
                 <?php
                    ...
                    ?>        
                       <li class="">
                            <a href="<?php print_r(base_url('admin/'.$main_menu['url'])); ?>"><?php echo $main_menu["menu_icon"]; ?></i> <span class="nav-label"><?php echo $main_menu['menu_name']; ?> <span class="fa arrow"></span></span><!-- <span class="fa arrow"></span> --></a>
